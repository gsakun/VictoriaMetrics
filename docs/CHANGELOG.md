...
* FEATUTE: [vmalert](https://docs.victoriametrics.com/vmalert.html): add `keep_firing_for` field for alerting rule. See [this issue](https://github.com/VictoriaMetrics/VictoriaMetrics/issues/4529).
